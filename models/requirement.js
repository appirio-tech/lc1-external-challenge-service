 ...
 * It's the same with Requirement model used in serenity-core,
 * but it adds hasMany relationship with Challenge model through ChallengeRequirement.
 */
module.exports = function(sequelize, DataTypes) {
  ...
  var Requirement = sequelize.define('Requirement', {
    ...
    associate : function(models) {
      Requirement.hasMany(models.Challenge, {through: models.ChallengeRequirement});
    }});
